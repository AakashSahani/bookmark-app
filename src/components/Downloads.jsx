	...
	return (
		<section className="text-center min-h-screen flex flex-col sm:justify-evenly space-y-10 py-5 px-[10%]">
			...
			<div className="flex flex-col sm:flex-row justify-center my-5">
				<div className="flex text-lg border my-5 mx-auto sm:mx-4 sm:my-0 w-[70vw]  sm:w-[275px] h-96 shadow rounded-lg flex-col justify-evenly  items-center">
					...
					<button className="w-fit px-4 h-12 shadow-xl rounded bg-softBlue text-white border-2 border-softBlue hover:bg-white hover:text-softBlue ">
						Add & Install Extension
					</button>
				</div>
				<div className="flex text-lg my-5 mx-auto sm:mx-4 sm:my-10 w-[70vw] sm:w-[275px] h-96 shadow border-2 rounded-lg flex-col justify-evenly  items-center">
				...
				<div className="flex text-lg my-5 mx-auto sm:mx-4 sm:my-20 w-[70vw] sm:w-[275px] h-96  shadow border-2 rounded-lg flex-col justify-evenly  items-center">
